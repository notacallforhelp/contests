...
void solve()
{
    ...
    vector<int> num={x,y,z}; sort(num.begin(),num.end());
    if(even>=3||even==2&&odd==1)
    {
        cout << total - num[2] << endl; return;
    }
    ...
    if(odd==2&&even==1)
    {
        if(num[2]%2==0)
        {
            cout << num[1]+num[0]-1 << endl; return;
        }
        else
        {
            cout << num[1]+num[0] << endl; return; 
        }
    }

    if(odd==3)
    {
        cout << num[0]+num[1]-1 << endl; return;
    }
}
