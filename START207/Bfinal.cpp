...
void solve()
{
    ...
    if(distinct)
    {
        ...
        for(int i=0;i<n;i++)
        {
            if(i==0)
            {
                P[prs[i].second]=prs[n-1].second;
                //cout << prs[n-1].second << endl;
            }
            else
            {
                P[prs[i].second]=prs[i-1].second;
                //cout << prs[i-1].second << endl;
            }
    ...
    for(int i=0;i<n;i++)
    {
        P[i+1]=pos[prs[i].first].back();
        pos[prs[i].first].pop_back();
