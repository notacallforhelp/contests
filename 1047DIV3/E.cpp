...
vector<int> make(vector<int> &A,int n)
{
    map<int,int> M;
    int mex = 0;
    vector<int> B = A;
...
void solve()
{
    ...
    vector<int> fst = make(A,n);
    vector<int> fst2 = make(fst,n);
    vector<int> fst3 = make(fst2,n);
    ...
    if(k==1)
    {
        int sum = accumulate(fst.begin(),fst.end(),0ll);
        cout << sum << endl;
    }
    else if(k%2==0)
    {
        int sum = accumulate(fst2.begin(),fst2.end(),0ll);
        cout << sum << endl;
    }
    else
    {
        int sum = accumulate(fst3.begin(),fst3.end(),0ll);
        cout << sum << endl;
    }
