...
void solve()
{
    ...
    if(s[0]=='1')
    {
        ...
        if(can&&oneidx>zidx)
        {
            changes = max(0ll,changes-2);
        }
        else if(can&&oneidx<zidx)
        {
            changes = max(0ll,changes-1);
        }
    }
    else if(s[0]=='0')
    {
